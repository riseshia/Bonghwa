...
SimpleTokenAuthentication.configure do |config|
  ...
  #   accordingly:
  #     `config.header_names =
  #       { super_admin: { phone_number: 'X-SuperAdmin-PhoneNumber' } }`
  #
  config.header_names = { user: { authentication_token: "X-User-Token",
                                  login_id: "X-User-Identifier" } }

  # Configure the name of the attribute used to identify the user
  # for authentication.
  ...
  #
  config.identifiers = { user: "login_id" }
